...
/**
 * Created by jiashen on 19-5-11.
 */
@Component
public class GetParasFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if (HttpMethod.POST.toString().equals(method)) {
            ...
            logger.info("get params: {}", requestQueryParams);
